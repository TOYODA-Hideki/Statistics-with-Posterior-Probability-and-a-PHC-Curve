...
gqcal(out1101$muAB[, ,1],2);    # Equation (11.4)
...
gqcal(out1101$eta2AB, 3);    # Explained Variance of the Interaction of Factors A and B
...
cellmean <- cbind(out1101$cellmean[, , 1], out1101$cellmean[, , 2])
...
PHC02(c = 0.0, cellmean, cc = "gtc", 3)

# E2between() Comparison of two cells (threshold rate reference points specified as a vector)
# x: Object of class 'E2Ind'
# H="A": Fixed factor, either A or B
# F=1: Integer, level of the fixed factor
# I=1: Integer, level of the compared factor with the larger mean
# J=2: Integer, level of the compared factor with the smaller mean
# cr1: Threshold rate reference points specified as a vector
# Table 11.7 Estimated Results of the Difference between 'Auditory Condition' and 'Exercise Condition' under 'Normal Condition'
E2between(out1101, H = "B", F = 1, I = 2, J = 4, cr1 = c(0, 1, 2), digits = 3)
...
gqcal(out1102$muAB[, ,1],2);    # Equation (11.4)
...
gqcal(out1102$eta2AB, 3);    # Explained Variance of the Interaction of Factors A and B
...
gqcal(out1103$muAB[, ,1],2);    # Equation (11.4)
...
#    The output is included in print(out1104, 3).
...
E2between(out1104, digits = 3, H = "A", F = 2, I = 4, J = 6, cr1 = c(0, 1, 2, 3))
