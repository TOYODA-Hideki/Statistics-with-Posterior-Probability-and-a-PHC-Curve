...
traceplot(out0301$fit, inc_warmup = F, pars=c("mu","sigma"),nrow=2)
...
print(out0301$fit,probs = c(0.025, 0.05, 0.5, 0.95, 0.975))
...
#Trace plot equivalent to Figure 3.1
traceplot(out0302$fit, inc_warmup = F, pars=c("mu","sigma"),nrow=2)
out0302$fit;            #Equivalent to Table 3.1 and Table 3.2
...
# 1), 2), 3)　Equivalent to Table 3.1 and Table 3.2
out0303$fit;      
