...
colnames(out1301$pi)<-paste("p",1:5,sep="")
gqcal(out1301$pi)                 ; #
...
# Table 13.9 Posterior Distribution of Parameters for 'Brand Recognition Problem 2'
# Table 13.12 Summary Statistics of Posterior Distribution of eij·V (Upper Brand)
# Table 13.13 Summary Statistics of Posterior Distribution of Ratio Lij of Joint Probabilities and Product of Marginal Probabilities
# pim: Parental Ratio for row i, column j (a × b)
# res: Pearson Residual (a × b)
# V: Cramer's Coefficient of Association
# L : Ratio of Joint Probabilities to the Product of Marginal Probabilities
print(out1302)

# Table 13.14 PHC Table for L11 and L12
PHC01(seq(1.24,1.30,0.01),out1302$L[,1,1],cc="gtc",byoga="no");
PHC01(seq(0.69,0.75,0.01),out1302$L[,1,2],cc="ltc",byoga="no");
...
# Table 13.12 Summary Statistics of Posterior Distribution of eij·V (Lower Cards)
# Table 13.13 Summary Statistics of Posterior Distribution of Ratio Lij of Joint Probabilities and Product of Marginal Probabilities
print(out1303)
...
# Table 13.18 Numerical Summary of Posterior Distribution of Joint Probabilities (parameters) for 'Pasta Problem'
# Table 13.19 Numerical Summary of Posterior Distribution of Cramer's Coefficient of Association and Marginal Probabilities for 'Pasta Problem'
# Table 13.20 Probability that Joint Probabilities are Greater than the Product of Marginal Probabilities
# Table 13.21 Summary Statistics of Posterior Distribution of Ratio of Proportions (First Half)
# pa: Marginal Probability of row i (a)
# pb: Marginal Probability of column j (b)
...
PHC01(seq(1.10,1.40,0.05),out1304$L[,2,2],cc="gtc",byoga="no");
PHC01(seq(1.10,1.40,0.05),out1304$L[,3,3],cc="gtc",byoga="no");
