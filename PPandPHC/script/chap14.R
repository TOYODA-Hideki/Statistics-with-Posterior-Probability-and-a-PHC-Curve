...
fit_tankaiki01 <- rstan::read_stan_csv(csrfit_tankaiki01$output_files())  # In stan format

# Save the 'fit_tankaiki01' object to a file
# save(fit_tankaiki01, file = "./script/obje/out1401")

# Load a previously saved 'fit_tankaiki01' object
# load(file = "./script/obje/out1401")

# Extract random samples from the fitted model
ext_tankaiki01 <- extract(fit_tankaiki01, par)
...
fit_tankaiki02 <- Reg(parent_child_height[, 2], parent_child_height[, 1], cha = 5, ite = 21000)
